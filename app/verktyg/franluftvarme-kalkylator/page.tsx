    ...
    <>
      ...
      <div className="max-w-4xl mx-auto pt-8 px-4">
        ...
        <p className="text-sm text-slate-500 text-center mb-8">
          <em>Uppdaterad: 22 augusti 2026. Data baserad på <a href="https://skvp.se" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#0f766e]">Svenska Kyl & Värmepumpföreningen (SKVP)</a>, Energimyndigheten samt branschsnitt för 2026.</em>
        </p>
      </div>
      ...
      <article className="max-w-4xl mx-auto py-12 px-4 text-slate-700">
        ...
        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-6">Hur lång livslängd har en frånluftsvärmepump?</h2>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold text-slate-800 mt-8 mb-4">Hur mycket el sparar man med frånluftsvärme?</h3>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-6">Kan jag få ROT-avdrag för frånluftsvärmepump?</h2>
        <p className="mb-4">
          Ja, du har rätt att använda ROT-avdraget för arbetskostnaden när du installerar en frånluftsvärmepump. För värmepumpar tillämpas ofta en schablon från <a href="https://www.skatteverket.se/privat/fastigheterochbostad/rotochrutarbete.4.2e56d4ba1202f95012080002966.html" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#0f766e]">Skatteverket</a> där arbetskostnaden räknas som 30% av totalkostnaden. Du får dra av 30% av denna arbetskostnad (vilket motsvarar 9% av totalkostnaden). Detta är inbyggt i vår kalkylator.
        </p>
        ...
        <div className="bg-emerald-50 border border-emerald-100 rounded-lg p-6 mt-8">
          ...
          <p className="text-emerald-800 mb-0">
            ...
            Ladda upp din offert på <a href="/" className="underline font-semibold">startsidan</a> så granskar vi den åt dig kostnadsfritt!
          </p>
        </div>
